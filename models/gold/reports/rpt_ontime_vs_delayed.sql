...
-- NOTE: dim_stores has no "region" or "store_type" column in this
-- project. address_state and size_category are used instead.
...
SELECT
    ...
    ROUND(
        ...
        * COUNT(
        ...
        / NULLIF(COUNT(DISTINCT inventory_key), 0),
        2
